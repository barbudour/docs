...
```bash
curl -X POST "https://speshu.ai/api/v1/audio/transcriptions" \
...
response = requests.post(
    'https://speshu.ai/api/v1/audio/transcriptions',
...
const response = await fetch('https://speshu.ai/api/v1/audio/transcriptions', {
  method: 'POST',
  headers: {
