...
openapi: GET /v1/history/generations
...
```bash
curl "https://speshu.ai/api/v1/history/generations" \
  -H "Authorization: Bearer YOUR_API_KEY"
```

```bash
curl "https://speshu.ai/api/v1/history/generations?requestType=chat&status=completed&dateFrom=2025-01-01T00:00:00Z&limit=50" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
response = requests.get(
    'https://speshu.ai/api/v1/history/generations',
...
```bash
curl "https://speshu.ai/api/v1/history/generations/gen_581761234567890123" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
