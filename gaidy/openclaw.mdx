---
title: "OpenClaw"
description: "Интеграция SpeShu.AI с OpenClaw — мультиканальным AI-ассистентом для мессенджеров"
icon: "paw"
---
...
<Steps>
    ...
    <Step title="Добавьте провайдер SpeShu.AI">
...
| Модель                | ID в SpeShu.AI                          | Для чего подходит                                                                                      |
| --------------------- | -------------------------------------- | ------------------------------------------------------------------------------------------------------ |
