---
title: "OpenCode"
description: "Интеграция Speshu с OpenCode — терминальным AI-ассистентом"
icon: "terminal"
---

<img src="https://mintcdn.com/polza/7DXGrHr-MeM25YhS/images/opencode.png?fit=max&auto=format&n=7DXGrHr-MeM25YhS&q=85&s=7f39a86c64821e94671669617d1ab07e" alt="OpenCode" width="2510" height="1778" data-path="images/opencode.png" />
...
Используйте скрипт автонастройки для подключения Speshu к OpenCode:
...
<Steps>
    ...
    <Step title="Введите API-ключ">
        Получите ключ в [личном кабинете](https://speshu.ai/dashboard/api-keys) и вставьте его в терминал.
    </Step>
