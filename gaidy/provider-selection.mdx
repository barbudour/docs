...
Speshu предоставляет доступ к моделям от разных провайдеров. В этом гайде вы узнаете, как выбирать оптимального провайдера для ваших задач.
...
По умолчанию Speshu автоматически выбирает оптимального провайдера на основе доступности, скорости и стоимости. Не нужно передавать параметр `provider` — система сама определит лучший вариант.
