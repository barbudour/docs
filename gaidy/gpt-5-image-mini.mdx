---
title: "GPT-5 Image Mini"
description: "Генерация изображений с моделью OpenAI GPT-5 Image Mini"
icon: "image"
---
...
| -------------- | ------------------------- |
| ID модели      | `openai/gpt-5-image-mini` |
...
| -------- | ------------ | ------------------------- |
| `model`  | Да           | `openai/gpt-5-image-mini` |
